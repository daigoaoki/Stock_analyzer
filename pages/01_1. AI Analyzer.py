...
if AIBacktest:
    ...
    Min_Child_Weight = st.sidebar.text_input("Min Child Weight", value=6)
    ETA = st.sidebar.text_input("eta", value=0.8035093985313301)
    SubSample = st.sidebar.text_input("Sub Sample", value=0.7209021079519456)
    ColSample = st.sidebar.text_input("Col Sample", value=0.7918336464716835)
    Alpha = st.sidebar.text_input("Alpha", value=0.5839837446495326)
    Lambda = st.sidebar.text_input("Lambda", value=0.7883568221055925)
    Gamma = st.sidebar.text_input("Gamma", value=0.9469939074558759)
